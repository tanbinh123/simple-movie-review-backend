...
public class AccountController {
    ...
    public ServiceResponseMessage<DefaultHttpRsp> modifyAccountPassword(@RequestBody ModifyAccountPasswordReq modifyAccountPasswordReq) {
    ...
    @ApiImplicitParams(value = {
            @ApiImplicitParam(name = "pageNum",value = "页码数",example = "1"),
    ...
    public ServiceResponseMessage<DefaultHttpRsp> fetchPageOfUsersProfile(@Min(value = 1,message = "页码数最少为1")@RequestParam(value = "pageNum") Integer pageNum,
                                                          @Min (value = 1,message = "每页数量最小为1")@RequestParam("pageSize") Integer pageSize) {
